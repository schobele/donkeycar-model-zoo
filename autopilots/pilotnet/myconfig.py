...
THROTTLE_FORWARD_PWM = 430  # pwm value for max$
THROTTLE_STOPPED_PWM = 370  # pwm value for no $
THROTTLE_REVERSE_PWM = 320  # pwm value for max$
...
MAX_EPOCHS = 40  # how many times to $

HAVE_IMU = False  # when true, this a$
IMU_SENSOR = 'mpu6050'          # (mpu6050|mpu9250)
IMU_DLP_CONFIG = 2              # Digital Lowpass $

CONDITIONAL_CMDS = False
...
AUGMENTATIONS = ['MULTIPLY', 'SHARPEN']
TRANSFORMATIONS = ['CROP', 'SIZE']
...
ROI_CROP_LEFT = 0
TRANSFORMATION_SIZE_W = 200
TRANSFORMATION_SIZE_H = 66
